...
_BENCHMARKS: dict[str, list[dict[str, Any]]] = {
    "cis_linux_v1.0": [
        ...
        },
        {
            ...
            "command": "grep -E '^PASS_MAX_DAYS' /etc/login.defs 2>/dev/null | awk '{print $2}' || echo 'N/A'",
            "expected": "365",
            "severity": "medium",
        },
        {
    ...
    "custom_hardening_v1.0": [
        ...
        },
        {
            ...
            "command": "grep -E '^\\*\\s+hard\\s+core\\s+0' /etc/security/limits.conf 2>/dev/null || echo 'NOT_RESTRICTED'",
